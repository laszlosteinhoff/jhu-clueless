...
public static partial class NetworkService
{
  ...
  public partial class NetworkServiceClient : grpc::ClientBase<NetworkServiceClient>
  {
    ...
    public virtual global::HeartbeatResponse heartbeat(global::HeartbeatRequest request, grpc::Metadata headers = null, global::System.DateTime? deadline = null, global::System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
    {
      return heartbeat(request, new grpc::CallOptions(headers, deadline, cancellationToken));
    }
    public virtual global::HeartbeatResponse heartbeat(global::HeartbeatRequest request, grpc::CallOptions options)
    {
      return CallInvoker.BlockingUnaryCall(__Method_heartbeat, null, options, request);
    }
    public virtual grpc::AsyncUnaryCall<global::HeartbeatResponse> heartbeatAsync(global::HeartbeatRequest request, grpc::Metadata headers = null, global::System.DateTime? deadline = null, global::System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
    {
      return heartbeatAsync(request, new grpc::CallOptions(headers, deadline, cancellationToken));
    }
    public virtual grpc::AsyncUnaryCall<global::HeartbeatResponse> heartbeatAsync(global::HeartbeatRequest request, grpc::CallOptions options)
    {
